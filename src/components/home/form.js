...
function Form() {
    ...
    const sendData = async (data) => {
      ...
      try {
          const response = await axios.post(process.env.API_URL || 'http://192.168.0.115:8000/crowdsource/data/', sendata );
    ...
    return (
            <div className="max-w-xl mx-auto p-6 bg-black rounded-lg  bg-opacity-40">
